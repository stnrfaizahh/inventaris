                        ...
                        <form action="{{ route('lokasi.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode_lokasi" id="kode_kategori" class="form-control" required>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12 d-flex justify-content-end">
                                    ...
                                    <a href="{{ route('lokasi.index') }}" class="btn btn-light-secondary me-1 mb-1">Batal</a>
